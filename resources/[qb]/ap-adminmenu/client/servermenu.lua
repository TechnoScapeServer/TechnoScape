    ...
    select = function()
        ...
        for _, v in ipairs(elements) do
            WeatherMenu:AddButton({icon = v.icon,label = v.label,value = v,description = v.description, select = function(btn)
                ...
                TriggerServerEvent('qb-admin:server:handleLog', 'weather', false, selection.label)
...
ServerMenu:AddSlider({
    ...
    select = function(_, value)
        TriggerServerEvent('qb-admin:server:handleLog', 'time', false, value)
...
ServerMenu:AddButton({
    ...
    select = function()
        ...
        if dialog then
            TriggerServerEvent('qb-admin:server:handleLog', 'stash', false, tostring(dialog.name))
