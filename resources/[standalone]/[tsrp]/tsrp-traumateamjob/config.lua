...
Config.Locations = { -- Edit the various interaction points for players or create new ones
    ["checking"] = {
	    [1] = vector3(307.43, -587.83, 43.19),
        [2] = vector3(311.56, -586.62, 43.19),
        [3] = vector3(308.18, -590.71, 43.19)
    },
    ["duty"] = {
        [1] = vector3(360.09, -578.21, 43.19),
    },
    ["vehicle"] = {
    },
    ["helicopter"] = {
    ...
    ["armory"] = {
        [1] = vector3(330.49, -598.95, 43.2),
    },
    ["roof"] = {
        [1] = vector4(338.5, -583.85, 74.16, 245.5),
    },
    ["main"] = {
        [1] = vector3(300.19, -594.6, 43.22),
    },
    ["stash"] = {
        [1] = vector3(329.24, -594.72, 43.22),
    },
    ["beds"] = {
        [1] = {coords = vector4(317.92, -581.65, 43.7, 246.37), taken = false, model = 1631638868},
        [2] = {coords = vector4(326.84, -585.07, 43.7, 62.55), taken = false, model = 1631638868},
        [3] = {coords = vector4(331.62, -586.95, 43.7, 247.18), taken = false, model = 1631638868},
        [4] = {coords = vector4(339.93, -590.04, 43.7, 64.37), taken = false, model = 1631638868},
        [5] = {coords = vector4(344.81, -592.2, 43.73, 239.39), taken = false, model = 1631638868},
        [6] = {coords = vector4(353.2, -595.23, 43.73, 69.27), taken = false, model = 1631638868},
    },
    ["jailbeds"] = {
