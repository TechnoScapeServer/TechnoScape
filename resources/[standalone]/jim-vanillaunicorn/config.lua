...
Config = {
	...
	PrintDebug = true, -- false to remove f8 debug messages for the script

	img = "core_inventory/html/img", -- Change this to your inventory's name and image folder (SET TO "" IF YOU HAVE DOUBLE IMAGES)
