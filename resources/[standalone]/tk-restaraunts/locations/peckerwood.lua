Config.Locations["Peckerwood"] = {}

--Job Info
Config.Locations["Peckerwood"].JobName = "peckerwood"
Config.Locations["Peckerwood"].BossGradeLevel = 2
Config.Locations["Peckerwood"].label = "Peckerwood"
Config.Locations["Peckerwood"].StockPrice = 1000

--Locations
Config.Locations["Peckerwood"].WarehouseLocation = vector4(-84.5, 6497.92, 31.49, 42.56)
Config.Locations["Peckerwood"].BossComputerLocation = vector4(-298.57, 6171.33, 31.29, 311.25)

Config.Locations["Peckerwood"].DutyLocations = {
    vector4(-289.8, 6169.4, 31.5, 53.09),
}

Config.Locations["Peckerwood"].WashHandsLocations = {
    vector4(-292.86, 6174.07, 30.35, 134.35),
    vector4(-299.57, 6185.94, 31.47, 315.0)
}

Config.Locations["Peckerwood"].Storage = {
...
Config.Locations["Peckerwood"].IceMakers = {
    vector4(-298.14, 6184.41, 31.55, 312.94)
}

Config.Locations["Peckerwood"].Fridges = {
...
Config.Locations["Peckerwood"].BarLocations = {
    vector4(-302.11, 6180.24, 31.56, 225.49)
}

Config.Locations["Peckerwood"].OvenLocations = {
...
-- Config.Locations["Peckerwood"].Taps = {
--     vector4(-304.67, 6182.52, 31.91, 38.23),
--     vector4(-305.29, 6181.97, 31.14, 44.78)
-- }

--Items
Config.Locations["Peckerwood"].PalleteItem = 'peckerwood_crate'
Config.Locations["Peckerwood"].Items = {
    {
...
--Crafting
Config.Locations["Peckerwood"].CraftingMenus = {
    ["Icebox"] = {
        {
            ['ice'] = {},
            ["amount"] = 3
