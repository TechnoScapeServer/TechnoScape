...
Config.Locations = {
	...
	{	job = "cybergarage",
		zones = {
			vector2(719.39, -778.88),
			vector2(674.95, -779.8),
			vector2(675.51, -726.23),
			vector2(719.84, -725.42),
		},
		autoClock = { enter = false, exit = false, },
		stash = { { coords = vector4(690.78, -756.95, 24.99, 269.79), w = 3.6, d = 0.6 }, },
		store = { { coords = vec4(-37.53, -1036.11, 28.6, 340.0), w = 1.6, d = 0.6 }, },
		crafting = { { coords = vector4(681.34, -761.82, 24.99, 270.76), w = 4.0, d = 0.6 }, },
		clockin = { { coords = vector4(686.63, -775.82, 24.79, 185.35), prop = true, }, },
		-- manualRepair = { { coords = vector4(708.39, -761.64, 24.99, 188.33), prop = true, } },
		garage = { spawn = vector4(713.73, -783.01, 24.58, 252.44),
					out = vector4(712.34, -780.63, 24.6, 55.86),
					list = { "towtruck", "panto", "slamtruck", "cheburek", "utillitruck3" },
					prop = true, },
		payments = { coords = vector4(702.44, -745.49, 28.77, 277.66),
			...
			prop = true, },
		blip = vector3(706.51, -766.64, 25.03),
		bliplabel = "Cyber Garage",    -- Bennys Workshop next to PDM
		blipcolor = 29,
		discordlink = "",
