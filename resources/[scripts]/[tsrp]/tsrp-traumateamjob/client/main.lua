...
RegisterNetEvent('hospital:client:traumateamAlert', function(coords, text)
    local street1, street2 = GetStreetNameAtCoord(coords.x, coords.y, coords.z)
    local street1name = GetStreetNameFromHashKey(street1)
    local street2name = GetStreetNameFromHashKey(street2)
    QBCore.Functions.Notify({text = text, caption = street1name.. ' ' ..street2name}, 'traumateam')
        ...
        while listen do
            if IsControlJustPressed(0, 38) then
                ...
                if variable == "checkin" then
                   TriggerEvent('tsrp-traumateamjobb:checkin')
                    listen = false
                elseif variable == "beds" then
                    TriggerEvent('tsrp-traumateamjobb:beds')
                    listen = false
                end
            end
            Wait(1)
...
RegisterNetEvent('tsrp-traumateamjobb:checkin', function()
...
RegisterNetEvent('tsrp-traumateamjobb:beds', function()
                ...
                options = {
                    {
                        ...
                        event = "tsrp-traumateamjobb:checkin",
                        label = "Check In",
                    }
                },
                distance = 1.5
        ...
        for k, v in pairs(Config.Locations["beds"]) do
            exports['qb-target']:AddBoxZone("beds"..k,  v.coords, 2.5, 2.3, {
                ...
                options = {
                    {
                        type = "client",
                        event = "tsrp-traumateamjobb:beds",
                        icon = "fas fa-bed",
                        label = "Layin Bed",
                    }
                },
