...
---
# Item installation
- Add the image files from the zip to your `lj-inventory > html > images` folder
...
I have only done this with `lj-inventory` and `lj-inventory` as they are similar
...
## Update v2.5:
	...
	- Repairs now uses custom stash event, not requiring lj-inventory default events anymore.
