...
Config.Vale = false -- Impound & destory & display of exploded vehicles in the garage or in an impound garage
Config.Impound = true -- Impound system
